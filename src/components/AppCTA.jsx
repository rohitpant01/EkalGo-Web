...
export default function AppCTA() {
  ...
  const handleAndroid = () => {
    openWaitlist({
      ...
      description: "Join the waitlist to be first in line when our Android app becomes available for general download."
    });
  };
  ...
  const handleIOS = () => {
    openWaitlist({
      ...
      description: "We're currently perfecting our iOS experience. Join the waitlist for exclusive early access."
    });
  };
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  <div className="text-left">
                    <div className="text-xs text-blue-200/50">Coming to</div>
                ...
                <button
                  ...
                  <div className="text-left">
                    <div className="text-xs text-blue-200/50">Coming to the</div>
